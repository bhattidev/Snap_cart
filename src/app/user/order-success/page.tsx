...
const OrderSuccess = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh]  px-6 pb-6 text-center bg-linear-to-b from-green-50 to-white">
      <motion.div
      ...
      >
        ...
        >
          <div className="w-full h-full rounded-full bg-green-700 blur-lg "></div>
        </motion.div>
      </motion.div>
      <motion.h1
      ...
      >
        <Link href={"/user/my-order"}>
          <motion.div
            ...
            whileTap={{ scale: 0.93 }}
            className="flex itemce' gap-2 bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 py-3 rounded-full shadow-lg transition-all"
          >
            Go to My Order Page
            <ArrowRight />
          </motion.div>
      ...
      >
        ...
        <div className="absolute top-8 left-[30%] w-2 h-2 bg-green-400 rounded-full animate-pulse" />
        ...
        <div className="absolute top-8 left-[90%] w-2 h-2 bg-green-400 rounded-full animate-bounce" />
      </motion.div>
    </div>
  );
};
