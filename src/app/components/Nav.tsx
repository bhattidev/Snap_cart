    ...
    ? createPortal(
        <AnimatePresence>
          <motion.div
            ...
            className="fixed top-0 left-0 h-full w-[75%] sm:w-[60%]  z-50 bg-linear-to-b from-green-800/90 via-green-700/80 to-green-900/90 backdrop-bluer-xl border-r border-green-400/20 shodow-[0_0_50px_-10px_rgba(0_255,100,0.3)] flex flex-col p-6 text-white "
          >
    ...
    <div className="w-[95%] fixed top-4 left-1/2 -translate-x-1/2 bg-linear-to-r from-green-500 to-green-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-20 px-4 md:px-8 z-50">
      ...
      <div className="flex items-center gap-3 md:gap-6 relative">
        ...
        <div ref={profileDropDown} className="relative">
          <div
            className="relative bg-white flex items-center justify-center rounded-full w-11 h-11 overflow-hidden shadow-md hover:scale-105 transition-transform cursor-pointer"
