  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6">
      ...
      <motion.button
        ...
        className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 hover:cursor-pointer text-white font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-10"
        onClick={() => nextStep(2)}
      >
        Next
        <ArrowRight />
